...
import { MapPin, Calendar, Star, Users, ArrowRight, Heart, Navigation } from 'lucide-react';
...
export default function PackageCard({ 
  ...
  const rating = (4.5 + (pkg.places.length % 5) / 10).toFixed(1);
  ...
  return (
    <motion.div 
      className="bg-white rounded-2xl shadow-lg hover:shadow-xl overflow-hidden transition-all duration-300 h-full flex flex-col"
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="mt-auto pt-4 border-t border-gray-100">
            <div className="flex justify-between items-center">
              ...
              <motion.button
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-semibold text-sm shadow-lg shadow-blue-100"
